...
class Manager:
    """Manager class responsible for loading data and providing methods to manage
    apartments, tenants, transfers, bills, and apartment events.
    """
    ...
    def get_apartment(self, apartment_key: str) -> Apartment | None:
        ...
        Args:
        ----
            apartment_key (str): The key/ID of the apartment to get.

        Returns:
        -------
            Apartment | None: The Apartment in question or `None` if the apartment doesn't exist.
    ...
    def get_apartment_costs(
        ...
        Args:
        ----
            apartment_key (str): The key/ID of the apartment for which to calculate the costs.
            year (int): The year for which to calculate the costs.
            month (int): The month for which to calculate the costs.

        Returns:
        -------
            float: Costs of the apartment.
    ...
    def get_settlement(
        ...
        Args:
        ----
            apartment_key (str): The key/ID of the apartment for which to calculate the settlement.
            year (int): The year for which to calculate the settlement.
            month (int): The month for which to calculate the settlement.

        Returns:
        -------
            ApartmentSettlement: Te ApartmentSettlement object generated from the apartment.
    ...
    def get_debtors(self, apartment_key: str, year: int, month: int) -> list[str]:
        ...
        Args:
        ----
            apartment_key (str): The key/ID of the apartment for which to list the debtors.
            year (int): The year for which to list the debtors.
            month (int): The month for which to list the debtors.
